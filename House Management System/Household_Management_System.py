...
class NewprojectApp:
    ...
    def whatsapp(self):
        import pywhatkit
        pywhatkit.sendwhatmsg("+919382770474",self.sl_text_area.get("1.0","end-1c"),datetime.now().hour,datetime.now().minute+1)
    ...
    def __init__(self,u,master=None):
        # build ui
        ...
        self.REGISTER.place(anchor="nw", height=30, width=120, x=40, y=130)
        ...
        self.add.place(anchor="nw", height=30, width=120, x=40, y=190)
        ...
        self.show_items.place(anchor="nw", height=30, width=120, x=40, y=250)
        ...
        self.shoping_List.place(anchor="nw", height=30, width=120, x=40, y=310)
        ...
        self.setting.configure(
            ...
            foreground="#ffffff",
            text='SETTING')
        self.setting.place(anchor="nw", height=30, width=120, x=40, y=370)
        ...
        self.user.configure(
            background="#ffffff",
            font="{Arial} 14 {bold}",
            text='Wlecome '+self.us)
        self.user.place(anchor="nw", height=30, width=199, x=0, y=70)
        
        #User Image
        '''self.img = tk.PhotoImage(file='user1.png')
        self.user_img = tk.Label(self.main)
        self.user_img.configure(
            background="#ffffff",
            font="{Arial} 14 {bold}",
            image=self.img)
        self.user_img.place(anchor="nw", height=30, width=30, x=10, y=70)'''
